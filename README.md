...
### Overview
**This dataset provides a comprehensive look at global workforce reductions across various industries, funding stages, and geographic regions between 2020 and 2026.<br>**
...
• Restructuring<br>
• AI Automation<br>
• M&A Activity (Mergers and Acquisitions)<br>
• Overexpansion<br>
## Potential Use Cases
1. Predictive Modeling: Use funding data, revenue growth, and hiring status to predict the likelihood or severity of future layoffs.
2. Economic Trend Analysis: Compare the impact of the "Pandemic Impact" cycle vs. the "AI Restructuring" cycle on mid-size startups.
3. Industry Benchmarking: Analyze which sectors (e.g., FinTech vs. Manufacturing) have shown more resilience during tech corrections.
4. Geographic Visualization: Map layoff counts across different continents and countries over time.
